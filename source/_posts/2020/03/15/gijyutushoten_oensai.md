...
ドメイン駆動設計(DDD)は名前は聞いたことがある、部分的には知っているという人が増えてきたように感じています。ただ導入するには全体像が大きすぎてどこから手を付ければいいのか分からないケースは結構あると思います。ドメインモデルや集約の切り方に自身を持てなかったり、CQRSの使い所に悩んだりして、結局そこに自身を持てないから導入を見合わせたりして、もやもやが溜まったりなどです。
