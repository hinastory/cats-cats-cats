...
本記事の趣旨とは少し外れるけど便利なガジェットを紹介します。{% elink ホットサンドソロ https://4w1h.jp/product/hotsand/ %}です。以前使ったことのあるホットサンドメーカーだと2枚1組で作るので分量的に多かったのですがこのホットサンドソロだと8枚切りの食パン1枚で作れてちょうど良かったです。しかもパンのミミがカリカリに仕上がって最高に美味しいです。正直これ食べたら他のホットサンドを食べたくなくなるくらい強烈です。

{% img /gallery/daily/others/hotsand1.jpeg 248 %}{% img /gallery/daily/others/hotsand2.jpeg 250 %}

とりあえず、今めちゃくちゃハマっててリモートワークの間食としておすすめです。以下、おすすめのレシピです。
...
リモートワーク中に使えて、**「ちょっと便利」**を演出する小粋な家電製品を紹介しました。他にもいろいろあると思いますが、自室にこもりきりになるリモートワークだからこそ気分転換や便利さを追求して快適な仕事環境を手に入れたいと思っています。

| 番号  | 製品名 | 種別 | 価格(参考)  | 順位([^1])|
|---|----------|--------|---|---|
