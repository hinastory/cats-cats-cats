...
導入期が終わって認定試験の感触がつかめたら訓練期に移行します。この期間ではひたすら擬似問題を解きます。擬似問題の最初としては以下の対策本から始めるのがおすすめです。
...
擬似問題で対策本以外で利用したのは以下の２つです。Udemyの方はセールのときに購入しました。かなりボリュームがあります。「AWS WEB問題集で学習しよう」の方はクイズ形式ですぐに解答が見れるのでやりやすかったです。
